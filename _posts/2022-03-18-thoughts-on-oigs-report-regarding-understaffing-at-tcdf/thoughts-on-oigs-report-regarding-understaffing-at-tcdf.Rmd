...
It bears noting that TCDF passed the two most recent regular facility [inspections](https://www.ice.gov/detain/facility-inspections) that were performed by the private contractors Nakamoto Group. The most recent of those was months before OIG arrived. Nakamoto inspectors passed the facility with only a single deficient standard. The inspection cover letter notes that "the current staffing level is at fifty percent of the authorized correctional/security positions" and that "[s]taff is currently working mandatory overtime shifts" [@ero2021]. The inspection cover letter also notes problems with sanitation, food service, and water temperatures. The Lead Compliance Inspector recommended a rating of Does Not Meet Standards [@ero2021a, pg 5].

Based on my experience, it is exceedingly rare for facilities to fail an inspection. Working with students, we've tallied attributes for 315 inspections and of these 300 passed while 14 were rated either Does Not Pass or Deficient. That is a 96% pass rate, so it is significant that TCDF failed the July 2021 inspection.

May 3-7, 2021, the Office of Detention Oversight inspected the facility

This is a very different result than what OIG found months later.
