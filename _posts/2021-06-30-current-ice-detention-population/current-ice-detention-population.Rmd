...
description: |
  Current and regularly updated information on ICE detention population and COVID-19 levels.
author:
  - name: Nathan Craig
...
```{r Total-Confirmed-COVID-19, layout="l-body-outset", fig.cap="Total number of active COVID-19 cases plotted over time."}
...
```{r Cumulative-COVID-19, layout="l-body-outset", fig.cap="Cumulative COVID-19 cases in ICE detention plotted over time."}
# Cumulative COVID-19
...
```{r Total-COVID-19-Tests, layout="l-body-outset", fig.cap="Cumulative number of COVID-19 tests plotted over time."}
